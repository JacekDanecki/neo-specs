...
Patch0: %{url}/commit/028414b376d12d7d6fbb4939bca2a31a02b6a18f.patch
...
Requires:      intel-opencl-clang >= 9.0.4
...
cmake .. -Wno-dev -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/usr  \
 -DCOMMON_CLANG_LIBRARY_NAME=opencl-clang -DIGC_PREFERRED_LLVM_VERSION=9.0.0 -DIGC_PACKAGE_RELEASE=%{patch_version}
%make_build
popd
