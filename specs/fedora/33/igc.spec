...
BuildRequires: cmake gcc-c++ make flex bison python3 llvm10-devel clang10-devel llvm10-static
...
%changelog
* Tue Nov 03 2020 Jacek Danecki <jacek.danecki@intel.com> - 1.0.4241-2
- Rebuild 1.0.4241 with llvm10/clang10 packages
